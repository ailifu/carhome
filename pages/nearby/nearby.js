...
Page({
  ...
  getcatitems() {
    console.log('https://carinspect.xgyvip.cn/api/home/store/lists?page=' +
    this.data.page +
    '&pagesize=10' +
    '&lat=' +
    this.data.selflatitude +
    '&lng=' +
    this.data.selflongitude);
    request({
      url:
        'https://carinspect.xgyvip.cn/api/home/store/lists?page=' +
        this.data.page +
        '&pagesize=10' +
        '&lat=' +
        this.data.selflatitude +
